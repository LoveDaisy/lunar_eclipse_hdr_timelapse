...
for i = 1:total_files
    ...
    image_store(i).expo = image_info(i).expo;
    image_store(i).image = current_img;
    image_store(i).ev = current_ev;
    image_store(i).type = image_info(i).type;
    flags(i) = true;
